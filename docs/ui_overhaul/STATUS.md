...
| 屏幕/组件 | 设计锚点 | 状态 | 备注 |
|---|---|---|---|
| 主题注册(CoFitColors → MaterialApp) | #13a | ⬜ 未开始 | main.dart 目前还是 indigo seed 默认主题 |
...
| # | 缺口 | 现状 | 设计需要 | 决议 |
|---|---|---|---|---|
| G1 | 动作类型枚举 | `ActionTemplateCard.type` 为自由 String,Firestore 直读 | strength/cardio/core/flexibility 四类,决定类型色条 | 待定 |
| G2 | 卡片来源 | 无字段 | 官方/自建/好友分享 徽章 | 待定 |
